...
int main()
{
	...
	xTaskCreate(vLightLED1,"Light1",configMINIMAL_STACK_SIZE,&(xTaskHandle_blink[0]),tskIDLE_PRIORITY + 2,&xTaskHandle_light1);
	xTaskCreate(vLightLED2,"Light2",configMINIMAL_STACK_SIZE,&(xTaskHandle_blink[1]),tskIDLE_PRIORITY + 2,&xTaskHandle_light2);
	xTaskCreate(vLightLED3,"Light3",configMINIMAL_STACK_SIZE,&(xTaskHandle_blink[2]),tskIDLE_PRIORITY + 2,&xTaskHandle_light3);
